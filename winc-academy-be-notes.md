...
1. [SQL](https://github.com/tomlajtos/winc-academy-notes/blob/main/winc-academy-be-notes.md#sql--be-module-01)
2. [Getting Ready For Python](https://github.com/tomlajtos/winc-academy-notes/blob/main/winc-academy-be-notes.md#getting-ready-for-python--be-module-02)
3. [Data Types and Operations](https://github.com/tomlajtos/winc-academy-notes/blob/main/winc-academy-be-notes.md#data-types-and-operations--be-module-03)
...
## Functions, Loops, Conditionals | BE Module 04
## Modules, Packages, Third Party Code | BE Module 05
## Object Oriented Programming | BE Module 06
## Debugging and Testing | BE Module 07
## Python Frameworks: FLASK | BE Module 08
## Working With Relational Databases | BE Module 09
## Deploying Your Project | BE Module 10
